...
/// Functions to query ParceiroRecords (as a Stream and as a Future).
Future<int> queryParceiroRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ParceiroRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ParceiroRecord>> queryParceiroRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ParceiroRecord.collection,
      ParceiroRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ParceiroRecord>> queryParceiroRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
