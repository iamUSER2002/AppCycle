...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const Login2Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/profi',
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'profi') : const ProfiWidget(),
        ),
        FFRoute(
          name: 'Settings02',
          path: '/settings02',
          builder: (context, params) => const Settings02Widget(),
        ),
        FFRoute(
          name: 'mapa',
          path: '/mapa',
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'mapa') : const MapaWidget(),
        ),
        FFRoute(
          name: 'Post',
          path: '/post',
        ...
        FFRoute(
          ...
          path: '/comprar',
          asyncParams: {
            'postComprar': getDoc(['Anuncio'], AnuncioRecord.fromSnapshot),
          },
          builder: (context, params) => ComprarWidget(
            postComprar: params.getParam(
              'postComprar',
              ParamType.Document,
            ),
          ),
