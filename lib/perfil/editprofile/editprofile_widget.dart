  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserRecord> overlayUserRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final overlayUserRecord = overlayUserRecordList.isNotEmpty
            ? overlayUserRecordList.first
            : null;
        return Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await overlayUserRecord!.reference
                                      .update(createUserRecordData(
