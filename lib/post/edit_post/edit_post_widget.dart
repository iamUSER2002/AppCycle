  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AnuncioRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AnuncioRecord> editPostAnuncioRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editPostAnuncioRecord = editPostAnuncioRecordList.isNotEmpty
            ? editPostAnuncioRecordList.first
            : null;
              ...
              actions: [
                StreamBuilder<List<AnuncioRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<AnuncioRecord> iconButtonAnuncioRecordList =
                        snapshot.data!;
                    // Return an empty Container when the item does not exist.
                    if (snapshot.data!.isEmpty) {
                      return Container();
                    }
                    final iconButtonAnuncioRecord =
                        iconButtonAnuncioRecordList.isNotEmpty
                            ? iconButtonAnuncioRecordList.first
                            : null;
                    return FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        await widget.editar!.reference
                            .update(createAnuncioRecordData(
                          nome: _model.taskTextController1.text,
                          descricao: _model.descriptionTextController.text,
                          numTlmv: iconButtonAnuncioRecord?.numTlmv,
